...
from libraries.starkex_library import min_uint256
...
func initialize{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let (sender) = get_caller_address()
    with_attr error_message("StarkEx: FB"):
    ...
    ERC20.initializer('StarkEx Pair Token', 'LPT', 18)
...
func burn{
    ...
    with_attr error_message("StarkEx: ILB"):
...
func swap{
    ...
    with_attr error_message("StarkEx: IOA"):
    ...
    with_attr error_message("StarkEx: IL"):
    ...
    # Invalid to
    with_attr error_message("StarkEx: IT"):
        if to == token0:
            assert 1 = 0
        end
        if to == token1:
    ...
    with_attr error_message("StarkEx: IIA"):
    ...
    with_attr error_message("StarkEx: K"):
...
func _mint_part1{
    ...
    with_attr error_message("StarkEx: ILM"):
...
func _update{
    ...
    # Overflow
    with_attr error_message("StarkEx: OV"):
...
func _mintFee{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    let (feeTo) = IStarkExFactory.feeTo(contract_address=factory)
